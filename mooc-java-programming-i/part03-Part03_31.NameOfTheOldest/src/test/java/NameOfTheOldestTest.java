...
public class NameOfTheOldestTest {
    ...
    public void test1() {
        ...
        assertTrue(
                "When input was:\n " + input
                        + ", output was expected to end with string \"valeria\". Now the output was: " + out,
                out.endsWith("valeria"));
    }
    ...
    public void test2() {
        ...
        assertTrue(
                "When input was:\n " + input
                        + ", output was expected to end with string \"gabriel\". Now the output was: " + out,
                out.endsWith("gabriel"));
    }
    ...
    private void randomInputTest() {
        ...
        String out = io.getSysOut().replace(oldOut, "").trim();
        assertTrue("When input was:\n " + input + ", output was expected to end with string \"" + oName
                + "\". Now the output was: " + out, out.endsWith("" + oName));
    }
